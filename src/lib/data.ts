...
export const mockTests: MockTest[] = [
  ...
  {
    id: 'test-phy-kinematics',
    chapterId: 'phy-11-3',
    title: 'Physics: Kinematics & Projectile Motion',
    durationMinutes: 25,
    totalMarks: 25,
    difficulty: 'medium',
  },
  ...
  },
  {
    id: 'test-chem-atomic',
    chapterId: 'chem-11-2',
    title: 'Chemistry: Atomic Structure & Quantum Numbers',
    durationMinutes: 20,
    totalMarks: 20,
    difficulty: 'medium',
  },
  {
    id: 'test-chem-organic',
    chapterId: 'chem-12-2',
    title: 'Chemistry: Organic II — Reactions & Mechanisms',
    durationMinutes: 30,
    totalMarks: 30,
    difficulty: 'hard',
  },
  {
    id: 'test-cs-programming',
    chapterId: 'cs-11-3',
    title: 'CS: C Programming Fundamentals',
    durationMinutes: 25,
    totalMarks: 25,
    difficulty: 'medium',
  },
  ...
  },
  {
    id: 'test-math-series',
    chapterId: 'math-11-1',
    title: 'Math: Sequences, Series & AP/GP',
    durationMinutes: 20,
    totalMarks: 20,
    difficulty: 'easy',
  },
...
export const notes: Note[] = [
  ...
  },
  {
    ...
    content: '<p>The International System of Units (SI) defines seven base units: second (time), metre (length), kilogram (mass), ampere (electric current), kelvin (thermodynamic temperature), mole (amount of substance), and candela (luminous intensity). All other units are derived from these.</p>',
  },
  {
    ...
    content: '<p>Stoichiometry studies quantitative relationships between reactants and products using balanced chemical equations and the conservation of mass. It relates moles, molar ratios, and masses to predict product amounts and required reactant quantities.</p>',
  },
  { id: 'note-eng-11-1', chapterId: 'eng-11-1', type: 'theory', title: 'Education and Humanity — Overview', content: '<p>Unit summary and exercises with vocabulary, grammar, and comprehension.</p>' },
  { id: 'note-eng-11-2', chapterId: 'eng-11-2', type: 'theory', title: 'Communication — Overview', content: '<p>Unit summary and practice tasks focused on communication skills.</p>' },
  { id: 'note-eng-11-3', chapterId: 'eng-11-3', type: 'theory', title: 'Media and Society — Overview', content: '<p>Unit summary: media influence, society, and critical reading.</p>' },
  { id: 'note-eng-11-4', chapterId: 'eng-11-4', type: 'theory', title: 'History and Culture — Overview', content: '<p>Unit summary with thematic text and comprehension exercises.</p>' },
  { id: 'note-eng-11-5', chapterId: 'eng-11-5', type: 'theory', title: 'Life and Love — Overview', content: '<p>Unit summary: vocabulary and comprehension about life and love.</p>' },
  { id: 'note-eng-11-6', chapterId: 'eng-11-6', type: 'theory', title: 'Health and Exercise — Overview', content: '<p>Unit summary: health, wellness, and grammar exercises.</p>' },
  { id: 'note-eng-11-7', chapterId: 'eng-11-7', type: 'theory', title: 'Ecology and Development — Overview', content: '<p>Unit summary: ecology topics with reading and writing practice.</p>' },
  { id: 'note-eng-11-8', chapterId: 'eng-11-8', type: 'theory', title: 'Humour and Satire — Overview', content: '<p>Unit summary with exercises on humour and satire.</p>' },
  { id: 'note-eng-11-9', chapterId: 'eng-11-9', type: 'theory', title: 'Democracy and Human Rights — Overview', content: '<p>Unit summary: rights, democracy, and critical thinking tasks.</p>' },
  { id: 'note-eng-11-10', chapterId: 'eng-11-10', type: 'theory', title: 'Home Life and Family Relationship — Overview', content: '<p>Unit summary with exercises about family life and relationships.</p>' },
  { id: 'note-eng-11-11', chapterId: 'eng-11-11', type: 'theory', title: 'Arts and Creations — Overview', content: '<p>Unit summary on arts and creative expression.</p>' },
  { id: 'note-eng-11-12', chapterId: 'eng-11-12', type: 'theory', title: 'Fantasy — Overview', content: '<p>Unit summary with reading comprehension and vocabulary.</p>' },
  { id: 'note-eng-11-13', chapterId: 'eng-11-13', type: 'theory', title: 'Career and Entrepreneurship — Overview', content: '<p>Unit summary on careers and entrepreneurship; practice tasks.</p>' },
  { id: 'note-eng-11-14', chapterId: 'eng-11-14', type: 'theory', title: 'Power and Politics — Overview', content: '<p>Unit summary with exercises on power and politics.</p>' },
  { id: 'note-eng-11-15', chapterId: 'eng-11-15', type: 'theory', title: 'War and Peace — Overview', content: '<p>Unit summary; reading and writing practice.</p>' },
  { id: 'note-eng-11-16', chapterId: 'eng-11-16', type: 'theory', title: 'Critical Thinking — Overview', content: '<p>Unit summary developing critical reasoning skills.</p>' },
  { id: 'note-eng-11-17', chapterId: 'eng-11-17', type: 'theory', title: 'Globalisation and Diaspora — Overview', content: '<p>Unit summary: globalization, diaspora; vocabulary tasks.</p>' },
  { id: 'note-eng-11-18', chapterId: 'eng-11-18', type: 'theory', title: 'Immigration and Identity — Overview', content: '<p>Unit summary; identity themes with exercises.</p>' },
  { id: 'note-eng-11-19', chapterId: 'eng-11-19', type: 'theory', title: 'Travel and Tourism — Overview', content: '<p>Unit summary; reading comprehension on travel/tourism.</p>' },
  { id: 'note-eng-11-20', chapterId: 'eng-11-20', type: 'theory', title: 'Science and Technology — Overview', content: '<p>Unit summary; key vocabulary and comprehension pointers.</p>' },
  { id: 'note-eng-11-lit-ss', chapterId: 'eng-11-lit-ss', type: 'theory', title: 'Short Stories — Overview', content: '<p>7 stories with complete exercise solutions (e.g., The Selfish Giant, The Oval Portrait).</p>' },
  { id: 'note-eng-11-lit-poems', chapterId: 'eng-11-lit-poems', type: 'theory', title: 'Poems — Overview', content: '<p>5 poems with summary and exercises (e.g., Corona Says, A Red, Red Rose).</p>' },
  { id: 'note-eng-11-lit-essays', chapterId: 'eng-11-lit-essays', type: 'theory', title: 'Essays — Overview', content: '<p>5 essays with complete exercises (e.g., Sharing Tradition, How to Live Before You Die).</p>' },
  { id: 'note-eng-11-lit-plays', chapterId: 'eng-11-lit-plays', type: 'theory', title: 'One Act Plays — Overview', content: '<p>3 plays: Trifles, A Sunny Morning, Refund — exercise solutions available.</p>' },
  {
    id: 'note-eng-11-20-1',
    chapterId: 'eng-11-20',
    type: 'theory',
    title: 'Science and Technology — Key Vocabulary',
    content: '<p>Freshman: first-year student; Naive: lacking experience; Dorm: student residence; Suitemate: someone sharing suite facilities; Incalculable: cannot be measured; Brag: boast; Disposal: throwing away.</p>',
  },
  {
    id: 'note-eng-11-20-2',
    chapterId: 'eng-11-20',
    ...
    content: '<p>The piece contrasts a parent\'s college experience with modern tech-driven student life, noting increased connectivity but fragmented real-world interactions.</p><ul><li>Tools: mobile apps, social media, YouTube</li><li>Impacts: reliance on shortcuts, reduced exploration</li></ul>',
  },
  {
    id: 'note-nep-11-7-1',
    chapterId: 'nep-11-7',
    ...
    content: '<p>विहङ्गम दृष्टि: चराले जस्तै माथिबाट हेर्ने दृष्टि; तृणहारी: घाँसपात खाने; पर्यापर्यटन: विविधताका कारण हुने पर्यटन; जलक्रीडा: पानीमा खेलिने खेलहरू; पर्यावरणमैत्री: वातावरण सुहाउँदो।</p>',
  },
  {
    id: 'note-nep-11-7-2',
    chapterId: 'nep-11-7',
    ...
    content: '<p>पाठ दस अनुच्छेदमा संरचित छ। पर्यापर्यटनले स्थानीय विविधता, पर्यावरणमैत्री गतिविधि, जलक्रीडा, र पहाडी/तराई क्षेत्रका विशेषताको उपयोग गर्छ।</p>',
  },
  { id: 'note-nep-11-1', chapterId: 'nep-11-1', type: 'theory', title: 'वीर पुर्खा — सार', content: '<p>कविता अध्यायको सार तथा अभ्यास द्रुत पुनरावर्तनका लागि।</p>' },
  { id: 'note-nep-11-2', chapterId: 'nep-11-2', type: 'theory', title: 'गाउँको माया — सार', content: '<p>कथाको सार र मुख्य शब्दावली अभ्यासहरूको झलक।</p>' },
  { id: 'note-nep-11-3', chapterId: 'nep-11-3', type: 'theory', title: 'संस्कृतिको नयाँ यात्रा — सार', content: '<p>आत्मपरक निबन्धको सार र अभ्यास बुँदाहरू।</p>' },
  { id: 'note-nep-11-4', chapterId: 'nep-11-4', type: 'theory', title: 'योगमाया — सार', content: '<p>राष्ट्रिय जीवनी अध्यायको सार र शब्दभण्डार।</p>' },
  { id: 'note-nep-11-5', chapterId: 'nep-11-5', type: 'theory', title: 'साथीलाई चिठी — सार', content: '<p>चिठी अध्यायको मुख्य बुँदाहरू र अभ्यास संकेत।</p>' },
  { id: 'note-nep-11-6', chapterId: 'nep-11-6', type: 'theory', title: 'त्यो फेरि फर्कला ? — सार', content: '<p>मनोवैज्ञानिक कथाको सार र अभ्यास दृष्टान्त।</p>' },
  { id: 'note-nep-11-8', chapterId: 'nep-11-8', type: 'theory', title: 'लौ आयो ताजा खबर — सार', content: '<p>लघु नाटकको सार र अभ्यास बुँदाहरू।</p>' },
  { id: 'note-nep-11-9', chapterId: 'nep-11-9', type: 'theory', title: 'सफलताको कथा — सार', content: '<p>रिपोर्ताजमूलक रचनाको सार र अभ्यास संकेत।</p>' },
  { id: 'note-nep-11-10', chapterId: 'nep-11-10', type: 'theory', title: 'कृषिशालामा एक दिन — सार', content: '<p>संवाद अध्यायको सार र महत्वपूर्ण शब्दभण्डार।</p>' },
  { id: 'note-nep-11-11', chapterId: 'nep-11-11', type: 'theory', title: 'रारा भ्रमण — सार', content: '<p>दैनिकी अध्यायको सार र अभ्यास संकेत।</p>' },
  { id: 'note-nep-11-12', chapterId: 'nep-11-12', type: 'theory', title: 'जलस्रोत र ऊर्जा — सार', content: '<p>वक्तृता अध्यायको सार र अभ्यास बुँदाहरू।</p>' },
  { id: 'note-nep-12-1', chapterId: 'nep-12-1', type: 'theory', title: 'आमाको सपना — सार', content: '<p>अध्याय सार र अभ्यास झलक।</p>' },
  { id: 'note-nep-12-2', chapterId: 'nep-12-2', type: 'theory', title: 'विरहिणी दमयन्ती — सार', content: '<p>अध्याय सार र अभ्यास संकेत।</p>' },
  { id: 'note-nep-12-3', chapterId: 'nep-12-3', type: 'theory', title: 'घनघस्याको उकालो काट्ता — सार', content: '<p>अध्याय सार र शब्दभण्डार।</p>' },
  { id: 'note-nep-12-4', chapterId: 'nep-12-4', type: 'theory', title: 'व्यावसायिक पत्र — सार', content: '<p>अध्याय सार र अभ्यास बुँदाहरू।</p>' },
  { id: 'note-nep-12-5', chapterId: 'nep-12-5', type: 'theory', title: 'एक चिहान — सार', content: '<p>अध्याय सार र अभ्यास संकेत।</p>' },
  { id: 'note-nep-12-6', chapterId: 'nep-12-6', type: 'theory', title: 'स्टिफन विलियम हकिङ — सार', content: '<p>अध्याय सार र मुख्य बुँदाहरू।</p>' },
  { id: 'note-nep-12-7', chapterId: 'nep-12-7', type: 'theory', title: 'हामीलाई बोलाउँछन् हिमचुली — सार', content: '<p>अध्याय सार र अभ्यास संकेत।</p>' },
  { id: 'note-nep-12-8', chapterId: 'nep-12-8', type: 'theory', title: 'मातृत्व — सार', content: '<p>अध्याय सार र शब्दभण्डार।</p>' },
  { id: 'note-nep-12-9', chapterId: 'nep-12-9', type: 'theory', title: 'गोर्खे — सार', content: '<p>अध्याय सार र अभ्यास संकेत।</p>' },
  { id: 'note-nep-12-10', chapterId: 'nep-12-10', type: 'theory', title: 'नेपाली पहिचान — सार', content: '<p>अध्याय सार र शब्दभण्डार।</p>' },
  { id: 'note-nep-12-11', chapterId: 'nep-12-11', type: 'theory', title: 'सहकारी — सार', content: '<p>अध्याय सार र अभ्यास बुँदाहरू।</p>' },
  { id: 'note-nep-12-12', chapterId: 'nep-12-12', type: 'theory', title: 'जीवन मार्ग — सार', content: '<p>अध्याय सार र अभ्यास संकेत।</p>' },
  { id: 'note-cs-11-3-rn-1', chapterId: 'cs-11-3', type: 'theory', title: 'C Language — Overview (Readersnepal)', content: '<p>Comprehensive outline: history, features, control structures, arrays, strings, functions, pointers, structures, unions, and file handling.</p>' },
  { id: 'note-cs-11-3-rn-2', chapterId: 'cs-11-3', type: 'theory', title: 'C File Handling — Read & Display Records', content: '<p>Examples using FILE*, fopen, fscanf, printf, loops with EOF to read single/multiple records and filter output.</p>' },
  { id: 'note-cs-11-2-rn-1', chapterId: 'cs-11-2', type: 'theory', title: 'HTML — Overview (Readersnepal)', content: '<p>Definition, purpose, brief history, versions (HTML 1.0 to HTML5), workflow, and .html/.htm extensions.</p>' },
  { id: 'note-cs-11-2-rn-2', chapterId: 'cs-11-2', type: 'theory', title: 'CSS Types — Inline, Internal, External', content: '<p>Advantages of CSS and examples demonstrating inline styles, <style> block in head, and external stylesheet linkage.</p>' },
  { id: 'note-cs-12-1-rn-1', chapterId: 'cs-12-1', type: 'theory', title: 'SQL — Overview & Basic Commands', content: '<p>DBMS types (Relational vs Non-Relational), SQL basics: CREATE TABLE, INSERT, SELECT with examples.</p>' },
  { id: 'note-cs-12-1-rn-2', chapterId: 'cs-12-1', type: 'theory', title: 'DDL, DML, DCL — Examples', content: '<p>CREATE/DROP for schema and tables; SELECT/INSERT/UPDATE/DELETE for records; overview of control commands.</p>' },
  { id: 'note-cs-12-2-rn-1', chapterId: 'cs-12-2', type: 'theory', title: 'JavaScript — Basic Form Validation', content: '<p>Client-side validation using DOM APIs and alert for empty fields; onsubmit/onclick behaviors.</p>' },
  { id: 'note-cs-12-2-rn-2', chapterId: 'cs-12-2', type: 'theory', title: 'PHP + MySQL — Store Form Data', content: '<p>Localhost setup with XAMPP, PHP file to connect and insert form inputs into MySQL via phpMyAdmin.</p>' },
  ...
  // ── FORMULA NOTES (for Formulas tab) ──
  { id: 'form-phy-11-3', chapterId: 'phy-11-3', type: 'formula', title: 'Kinematics Formula Sheet',
    content: `<ul><li><strong>v = u + at</strong></li><li><strong>s = ut + ½at²</strong></li><li><strong>v² = u² + 2as</strong></li><li><strong>Range R = u²sin2θ/g</strong></li><li><strong>Max Height H = u²sin²θ/2g</strong></li><li><strong>Time of Flight T = 2u sinθ/g</strong></li></ul>` },
  { id: 'form-phy-11-4', chapterId: 'phy-11-4', type: 'formula', title: 'Laws of Motion Formula Sheet',
    content: `<ul><li><strong>F = ma</strong> (Newton 2nd)</li><li><strong>Impulse J = FΔt = Δp</strong></li><li><strong>Friction f = μN</strong></li><li><strong>Centripetal F = mv²/r</strong></li><li><strong>Centripetal acc a = v²/r = ω²r</strong></li></ul>` },
  { id: 'form-phy-11-5', chapterId: 'phy-11-5', type: 'formula', title: 'Work, Energy & Power Formula Sheet',
    content: `<ul><li><strong>W = F·s·cosθ</strong></li><li><strong>KE = ½mv²</strong></li><li><strong>PE = mgh</strong></li><li><strong>P = W/t = Fv</strong></li><li><strong>η = (Output/Input)×100%</strong></li></ul>` },
  { id: 'form-phy-11-6', chapterId: 'phy-11-6', type: 'formula', title: 'Thermodynamics Formula Sheet',
    content: `<ul><li><strong>Q = mcΔT</strong></li><li><strong>Q = mL</strong></li><li><strong>PV = nRT</strong></li><li><strong>L₂ = L₁(1+αΔT)</strong></li><li><strong>dQ = dU + dW</strong></li></ul>` },
  { id: 'form-phy-11-7', chapterId: 'phy-11-7', type: 'formula', title: 'Optics Formula Sheet',
    content: `<ul><li><strong>1/f = 1/v − 1/u</strong></li><li><strong>m = v/u</strong></li><li><strong>P = 1/f (D)</strong></li><li><strong>n₁sinθ₁ = n₂sinθ₂</strong></li><li><strong>μ = tan(iₚ)</strong> (Brewster)</li></ul>` },
  { id: 'form-phy-12-1', chapterId: 'phy-12-1', type: 'formula', title: 'Wave Optics Formula Sheet',
    content: `<ul><li><strong>β = λD/d</strong> (fringe width)</li><li><strong>Δx = nλ</strong> (bright)</li><li><strong>a sinθ = nλ</strong> (slit minima)</li><li><strong>I = I₀cos²θ</strong> (Malus)</li><li><strong>μ = tan(iₚ)</strong> (Brewster)</li></ul>` },
  { id: 'form-phy-12-2', chapterId: 'phy-12-2', type: 'formula', title: 'Current Electricity Formula Sheet',
    content: `<ul><li><strong>V = IR</strong></li><li><strong>R(series) = R₁+R₂</strong></li><li><strong>1/R(parallel) = 1/R₁+1/R₂</strong></li><li><strong>P = VI = I²R = V²/R</strong></li><li><strong>E₁/E₂ = l₁/l₂</strong></li></ul>` },
  { id: 'form-phy-12-3', chapterId: 'phy-12-3', type: 'formula', title: 'Modern Physics Formula Sheet',
    content: `<ul><li><strong>hν = Φ + KE_max</strong></li><li><strong>Eₙ = −13.6/n² eV</strong></li><li><strong>L = nh/2π</strong></li><li><strong>λ = h/mv</strong> (de Broglie)</li></ul>` },
  { id: 'form-chem-11-1', chapterId: 'chem-11-1', type: 'formula', title: 'Stoichiometry Formula Sheet',
    content: `<ul><li><strong>n = mass/M</strong></li><li><strong>N = n × 6.022×10²³</strong></li><li><strong>M = n/V(L)</strong></li><li><strong>N₁V₁ = N₂V₂</strong></li><li><strong>%purity = (pure/total)×100</strong></li></ul>` },
  { id: 'form-chem-11-5', chapterId: 'chem-11-5', type: 'formula', title: 'Equilibrium Formula Sheet',
    content: `<ul><li><strong>Kc = [P]/[R]</strong></li><li><strong>Kp = Kc(RT)^Δn</strong></li><li><strong>pH = −log[H⁺]</strong></li><li><strong>pH+pOH = 14</strong></li></ul>` },
  { id: 'form-math-11-1', chapterId: 'math-11-1', type: 'formula', title: 'Sequence & Series Formula Sheet',
    content: `<ul><li><strong>AP Tₙ = a+(n-1)d</strong></li><li><strong>AP Sₙ = n/2[2a+(n-1)d]</strong></li><li><strong>GP Tₙ = arⁿ⁻¹</strong></li><li><strong>GP Sₙ = a(rⁿ-1)/(r-1)</strong></li><li><strong>Σn = n(n+1)/2</strong></li></ul>` },
  { id: 'form-math-11-3', chapterId: 'math-11-3', type: 'formula', title: 'Derivatives Formula Sheet',
    content: `<ul><li><strong>d/dx(xⁿ) = nxⁿ⁻¹</strong></li><li><strong>d/dx(sin x) = cos x</strong></li><li><strong>d/dx(eˣ) = eˣ</strong></li><li><strong>d/dx(ln x) = 1/x</strong></li><li><strong>(uv)' = u'v+uv'</strong></li></ul>` },
  { id: 'form-math-12-2', chapterId: 'math-12-2', type: 'formula', title: 'Integration Formula Sheet',
    content: `<ul><li><strong>∫xⁿ dx = xⁿ⁺¹/(n+1)+C</strong></li><li><strong>∫eˣ dx = eˣ+C</strong></li><li><strong>∫sin x dx = −cos x+C</strong></li><li><strong>∫1/x dx = ln|x|+C</strong></li><li><strong>∫u dv = uv−∫v du</strong></li></ul>` },
  { id: 'form-cs-11-1', chapterId: 'cs-11-1', type: 'formula', title: 'Boolean Algebra Reference',
    content: `<ul><li><strong>AND: A·B</strong></li><li><strong>OR: A+B</strong></li><li><strong>De Morgan 1: (A·B)̄ = Ā+B̄</strong></li><li><strong>De Morgan 2: (A+B)̄ = Ā·B̄</strong></li><li><strong>NAND/NOR = Universal gates</strong></li></ul>` },
  {
...
export const questions: Question[] = [
  ...
  // ── Kinematics Test Questions ──
  {
    id: 'q-kin-1', testId: 'test-phy-kinematics', type: 'multiple-choice',
    question: 'A body is projected at 30° to horizontal with speed 20 m/s. Maximum height reached is (g=10):',
    options: ['5 m', '10 m', '15 m', '20 m'],
    correctAnswer: '5 m', marks: 1,
    explanation: 'H = u²sin²θ/2g = 400×0.25/20 = 5 m.',
  },
  {
    id: 'q-kin-2', testId: 'test-phy-kinematics', type: 'multiple-choice',
    question: 'Horizontal range is maximum when angle of projection is:',
    options: ['30°', '45°', '60°', '90°'],
    correctAnswer: '45°', marks: 1,
    explanation: 'R = u²sin2θ/g is maximum at sin2θ=1, i.e., θ=45°.',
  },
  {
    id: 'q-kin-3', testId: 'test-phy-kinematics', type: 'multiple-choice',
    question: 'A car accelerates from rest at 2 m/s². Speed after 5 s is:',
    options: ['5 m/s', '8 m/s', '10 m/s', '12 m/s'],
    correctAnswer: '10 m/s', marks: 1,
    explanation: 'v = u + at = 0 + 2×5 = 10 m/s.',
  },
  {
    id: 'q-kin-4', testId: 'test-phy-kinematics', type: 'multiple-choice',
    question: 'Velocity-time graph slope gives:',
    options: ['displacement', 'acceleration', 'speed', 'distance'],
    correctAnswer: 'acceleration', marks: 1,
    explanation: 'Slope of v-t graph = dv/dt = acceleration.',
  },
  {
    id: 'q-kin-5', testId: 'test-phy-kinematics', type: 'multiple-choice',
    question: 'A stone is dropped from height h. Time to reach ground is:',
    options: ['√(h/g)', '√(2h/g)', '2h/g', 'h/g'],
    correctAnswer: '√(2h/g)', marks: 1,
    explanation: 'h = ½gt² → t = √(2h/g).',
  },

  // ── Laws of Motion Test Questions ──
  {
    id: 'q-mech-1', testId: 'test-phy-mechanics', type: 'multiple-choice',
    question: 'A 5 kg mass accelerates at 3 m/s². Net force is:',
    options: ['8 N', '15 N', '2 N', '1.67 N'],
    correctAnswer: '15 N', marks: 1,
    explanation: 'F = ma = 5 × 3 = 15 N.',
  },
  {
    id: 'q-mech-2', testId: 'test-phy-mechanics', type: 'multiple-choice',
    question: 'Inertia of an object depends on:',
    options: ['velocity', 'mass', 'acceleration', 'force'],
    correctAnswer: 'mass', marks: 1,
    explanation: 'Inertia is the property of mass resisting change in motion.',
  },
  {
    id: 'q-mech-3', testId: 'test-phy-mechanics', type: 'multiple-choice',
    question: 'A 10 N force acts at 60° to displacement of 5 m. Work done:',
    options: ['25 J', '50 J', '43.3 J', '86.6 J'],
    correctAnswer: '25 J', marks: 1,
    explanation: 'W = Fs cosθ = 10×5×cos60° = 50×0.5 = 25 J.',
  },
  {
    id: 'q-mech-4', testId: 'test-phy-mechanics', type: 'multiple-choice',
    question: 'Static friction is always _____ kinetic friction:',
    options: ['less than', 'equal to', 'greater than or equal to', 'independent of'],
    correctAnswer: 'greater than or equal to', marks: 1,
    explanation: 'Maximum static friction ≥ kinetic friction.',
  },
  {
    id: 'q-mech-5', testId: 'test-phy-mechanics', type: 'multiple-choice',
    question: 'For circular motion, centripetal acceleration is directed:',
    options: ['tangentially', 'outward from center', 'toward center', 'upward'],
    correctAnswer: 'toward center', marks: 1,
    explanation: 'Centripetal means "center-seeking"; acceleration points inward.',
  },

  // ── Atomic Structure Test Questions ──
  {
    id: 'q-atom-1', testId: 'test-chem-atomic', type: 'multiple-choice',
    question: 'The principal quantum number (n) determines:',
    options: ['shape of orbital', 'orientation of orbital', 'energy and size', 'spin'],
    correctAnswer: 'energy and size', marks: 1,
    explanation: 'n determines the energy shell and size of the orbital.',
  },
  {
    id: 'q-atom-2', testId: 'test-chem-atomic', type: 'multiple-choice',
    question: 'Electronic configuration of Fe (Z=26) is:',
    options: ['[Ar] 4s² 3d⁶', '[Ar] 4s¹ 3d⁷', '[Kr] 4s² 3d⁶', '[Ar] 3d⁸'],
    correctAnswer: '[Ar] 4s² 3d⁶', marks: 1,
    explanation: 'Fe: 1s²2s²2p⁶3s²3p⁶3d⁶4s² = [Ar]3d⁶4s².',
  },
  {
    id: 'q-atom-3', testId: 'test-chem-atomic', type: 'multiple-choice',
    question: 'Hund\'s rule states that:',
    options: ['electrons fill lowest energy first', 'no two electrons have same 4 quantum numbers', 'pairing starts only after each orbital gets one electron', 'orbitals fill in order of n+l'],
    correctAnswer: 'pairing starts only after each orbital gets one electron', marks: 1,
    explanation: 'Hund\'s rule: maximum multiplicity — fill degenerate orbitals singly first.',
  },
  {
    id: 'q-atom-4', testId: 'test-chem-atomic', type: 'multiple-choice',
    question: 'The azimuthal quantum number (l) for d-subshell is:',
    options: ['0', '1', '2', '3'],
    correctAnswer: '2', marks: 1,
    explanation: 's=0, p=1, d=2, f=3.',
  },
  {
    id: 'q-atom-5', testId: 'test-chem-atomic', type: 'multiple-choice',
    question: 'Maximum electrons in a shell with n=3 is:',
    options: ['8', '18', '32', '2'],
    correctAnswer: '18', marks: 1,
    explanation: 'Max electrons = 2n² = 2×9 = 18.',
  },

  // ── Organic II Test Questions ──
  {
    id: 'q-org-1', testId: 'test-chem-organic', type: 'multiple-choice',
    question: 'SN1 reaction is favored by:',
    options: ['primary halides', 'methyl halides', 'tertiary halides', 'all equally'],
    correctAnswer: 'tertiary halides', marks: 1,
    explanation: 'Tertiary carbocations are more stable, favoring SN1.',
  },
  {
    id: 'q-org-2', testId: 'test-chem-organic', type: 'multiple-choice',
    question: 'Williamson synthesis is used to prepare:',
    options: ['alcohols', 'ethers', 'esters', 'aldehydes'],
    correctAnswer: 'ethers', marks: 1,
    explanation: 'R-X + R\'-ONa → R-O-R\' (ether) + NaX.',
  },
  {
    id: 'q-org-3', testId: 'test-chem-organic', type: 'multiple-choice',
    question: 'Which reagent converts alcohol to aldehyde?',
    options: ['KMnO4 (acidic)', 'PCC (mild oxidant)', 'H2/Pt', 'PCl5'],
    correctAnswer: 'PCC (mild oxidant)', marks: 1,
    explanation: 'PCC (Pyridinium chlorochromate) oxidizes primary alcohols to aldehydes.',
  },
  {
    id: 'q-org-4', testId: 'test-chem-organic', type: 'multiple-choice',
    question: 'Aldol condensation requires:',
    options: ['α-hydrogen', 'no hydrogen', 'aromatic ring', 'halogen'],
    correctAnswer: 'α-hydrogen', marks: 1,
    explanation: 'Aldehydes/ketones with α-H undergo aldol condensation with dilute base.',
  },
  {
    id: 'q-org-5', testId: 'test-chem-organic', type: 'multiple-choice',
    question: 'Cannizzaro reaction occurs with:',
    options: ['Methanol', 'Acetaldehyde', 'Formaldehyde (HCHO)', 'Acetone'],
    correctAnswer: 'Formaldehyde (HCHO)', marks: 1,
    explanation: 'HCHO (no α-H) undergoes disproportionation: 2HCHO + NaOH → HCOONa + CH3OH.',
  },

  // ── C Programming Test Questions ──
  {
    id: 'q-cp-1', testId: 'test-cs-programming', type: 'multiple-choice',
    question: 'Which data type stores a single character in C?',
    options: ['int', 'string', 'char', 'float'],
    correctAnswer: 'char', marks: 1,
    explanation: 'char stores a single character (1 byte).',
  },
  {
    id: 'q-cp-2', testId: 'test-cs-programming', type: 'multiple-choice',
    question: 'What is the output of: printf("%d", 5/2)?',
    options: ['2.5', '2', '3', '2.0'],
    correctAnswer: '2', marks: 1,
    explanation: 'Integer division in C truncates toward zero: 5/2 = 2.',
  },
  {
    id: 'q-cp-3', testId: 'test-cs-programming', type: 'multiple-choice',
    question: 'Which loop is guaranteed to execute at least once?',
    options: ['for', 'while', 'do-while', 'none'],
    correctAnswer: 'do-while', marks: 1,
    explanation: 'do-while checks condition after body executes.',
  },
  {
    id: 'q-cp-4', testId: 'test-cs-programming', type: 'multiple-choice',
    question: 'To access the value at a pointer p, we use:',
    options: ['&p', '*p', 'p[]', '@p'],
    correctAnswer: '*p', marks: 1,
    explanation: '* is the dereference operator to get value at address.',
  },
  {
    id: 'q-cp-5', testId: 'test-cs-programming', type: 'multiple-choice',
    question: 'Which function is used to open a file in C?',
    options: ['open()', 'fileopen()', 'fopen()', 'create()'],
    correctAnswer: 'fopen()', marks: 1,
    explanation: 'FILE *fp = fopen("name.txt", "r") opens a file.',
  },

  // ── SQL Test Questions ──
  {
    id: 'q-sql-1', testId: 'test-cs-sql', type: 'multiple-choice',
    question: 'Which SQL command retrieves data from a table?',
    options: ['INSERT', 'UPDATE', 'SELECT', 'DELETE'],
    correctAnswer: 'SELECT', marks: 1,
    explanation: 'SELECT is used to query/retrieve data from tables.',
  },
  {
    id: 'q-sql-2', testId: 'test-cs-sql', type: 'multiple-choice',
    question: 'Which keyword removes duplicate rows in SELECT?',
    options: ['UNIQUE', 'DISTINCT', 'DIFFERENT', 'ONLY'],
    correctAnswer: 'DISTINCT', marks: 1,
    explanation: 'SELECT DISTINCT col FROM table removes duplicates.',
  },
  {
    id: 'q-sql-3', testId: 'test-cs-sql', type: 'multiple-choice',
    question: 'CREATE TABLE is a _____ command.',
    options: ['DML', 'DDL', 'DCL', 'TCL'],
    correctAnswer: 'DDL', marks: 1,
    explanation: 'DDL (Data Definition Language) includes CREATE, ALTER, DROP.',
  },
  {
    id: 'q-sql-4', testId: 'test-cs-sql', type: 'multiple-choice',
    question: 'Which normal form eliminates transitive dependencies?',
    options: ['1NF', '2NF', '3NF', 'BCNF'],
    correctAnswer: '3NF', marks: 1,
    explanation: '3NF removes transitive dependencies (A→B→C becomes separate tables).',
  },
  {
    id: 'q-sql-5', testId: 'test-cs-sql', type: 'multiple-choice',
    question: 'GRANT and REVOKE belong to:',
    options: ['DDL', 'DML', 'DCL', 'TCL'],
    correctAnswer: 'DCL', marks: 1,
    explanation: 'DCL (Data Control Language) manages access permissions.',
  },

  // ── Math Series Test Questions ──
  {
    id: 'q-ser-1', testId: 'test-math-series', type: 'multiple-choice',
    question: 'In an AP with a=3, d=4, what is the 10th term?',
    options: ['39', '40', '43', '36'],
    correctAnswer: '39', marks: 1,
    explanation: 'T₁₀ = a + (n-1)d = 3 + 9×4 = 3 + 36 = 39.',
  },
  {
    id: 'q-ser-2', testId: 'test-math-series', type: 'multiple-choice',
    question: 'Sum of first n natural numbers is:',
    options: ['n(n-1)/2', 'n(n+1)/2', 'n²', '2n'],
    correctAnswer: 'n(n+1)/2', marks: 1,
    explanation: '1+2+...+n = n(n+1)/2.',
  },
  {
    id: 'q-ser-3', testId: 'test-math-series', type: 'multiple-choice',
    question: 'In a GP with a=2, r=3, what is the 4th term?',
    options: ['18', '54', '162', '6'],
    correctAnswer: '54', marks: 1,
    explanation: 'T₄ = ar³ = 2×27 = 54.',
  },
  {
    id: 'q-ser-4', testId: 'test-math-series', type: 'multiple-choice',
    question: 'If 3 numbers are in AP with sum 12, the middle number is:',
    options: ['3', '4', '6', '2'],
    correctAnswer: '4', marks: 1,
    explanation: 'For AP: (a-d) + a + (a+d) = 3a = 12, so a = 4.',
  },
  {
    id: 'q-ser-5', testId: 'test-math-series', type: 'multiple-choice',
    question: 'Common ratio of GP: 2, 6, 18, 54... is:',
    options: ['2', '3', '4', '6'],
    correctAnswer: '3', marks: 1,
    explanation: 'r = 6/2 = 3.',
  },

  // ── Optics Test Questions ──
  {
    id: 'q-opt-1', testId: 'test-phy-optics', type: 'multiple-choice',
    question: 'A convex lens has focal length 20 cm. Power is:',
    options: ['5 D', '0.2 D', '20 D', '-5 D'],
    correctAnswer: '5 D', marks: 1,
    explanation: 'P = 1/f = 1/0.20 m = 5 diopters.',
  },
  {
    id: 'q-opt-2', testId: 'test-phy-optics', type: 'multiple-choice',
    question: 'Snell\'s law: n₁sinθ₁ = n₂sinθ₂. What is it based on?',
    options: ['reflection', 'diffraction', 'refraction', 'polarization'],
    correctAnswer: 'refraction', marks: 1,
    explanation: 'Snell\'s law describes bending of light at an interface (refraction).',
  },
  {
    id: 'q-opt-3', testId: 'test-phy-optics', type: 'multiple-choice',
    question: 'Object at infinity forms image at:',
    options: ['centre', 'focus', '2F', 'virtual'],
    correctAnswer: 'focus', marks: 1,
    explanation: 'Parallel rays converge at the focal point of a convex lens.',
  },
  {
    id: 'q-opt-4', testId: 'test-phy-optics', type: 'multiple-choice',
    question: 'Which color has highest frequency?',
    options: ['Red', 'Green', 'Yellow', 'Violet'],
    correctAnswer: 'Violet', marks: 1,
    explanation: 'Violet has the shortest wavelength and highest frequency in visible spectrum.',
  },
  {
    id: 'q-opt-5', testId: 'test-phy-optics', type: 'multiple-choice',
    question: 'Total internal reflection occurs when:',
    options: ['angle < critical angle', 'angle > critical angle', 'angle = 0°', 'always'],
    correctAnswer: 'angle > critical angle', marks: 1,
    explanation: 'When angle of incidence exceeds critical angle, light reflects internally.',
  },
];
