...
import { ArrowRight, Book, Clock, FileText, Atom, FlaskConical, Calculator, Monitor, GraduationCap, Award } from 'lucide-react'
    ...
    <div className="flex flex-col min-h-screen">
      <section className="relative py-28 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="mt-2 max-w-2xl mx-auto text-base text-slate-600 dark:text-slate-400">
